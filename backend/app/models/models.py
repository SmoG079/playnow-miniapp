...
class Club(Base):
    ...
    split_ratio = Column(DECIMAL(4, 3), default=0.100)
...
class ClubMember(Base):
    ...
    role = Column(Enum(ClubMemberRole), default=ClubMemberRole.admin)
...
class SettlementRecord(Base):
    ...
    split_ratio = Column(DECIMAL(4, 3))
...
class Tournament(Base):
    ...
    venue_id = Column(BigInteger, ForeignKey("venues.id"))
    lock_venue = Column(Boolean, default=False)
    max_participants = Column(Integer)
    current_participants = Column(Integer, default=0)
    entry_fee = Column(DECIMAL(10, 2), default=0)
    cover_image = Column(String(512))
    group_chat_id = Column(String(64))
...
class TournamentRegistration(Base):
    ...
    status = Column(Enum(TournamentRegStatus), default=TournamentRegStatus.registered)
